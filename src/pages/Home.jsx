              ...
              <div className="mx-auto max-w-2xl">
                <div className="max-w-lg">
                  ...
                  <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
                    ...
                    and scalable web applications. Skilled in both front-end and back-end
                    development, I ensure seamless functionality. Proficient in various languages
                    and frameworks, I thrive in collaborative environments.
                  </p>
                  <div className="mt-10 flex items-center gap-x-6">
                    <Link
                      to="https://api.whatsapp.com/send/?phone=%2B6282253600917&text&type=phone_number&app_absent=0"
