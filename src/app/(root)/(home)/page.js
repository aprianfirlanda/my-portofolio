          ...
          <div className="flex flex-wrap">
            <div className="w-full self-center px-4 lg:w-1/2">
              <h1 className="text-base font-semibold text-primary md:text-xl">
                Hi, I am
                <span className="block text-4xl font-bold lg:text-5xl">Aprian Firlanda Imani</span>
              </h1>
              <h2 className="mb-5 text-lg font-medium">Full Stack Web Developer</h2>
              <p className="mb-10 font-medium">
                I have over 4 years of experience as a web developer, creating robust and scalable
                web applications. Skilled in both front-end and back-end development, I ensure
                seamless functionality. Proficient in various languages and frameworks, I thrive in
              ...
              >
                <FaWhatsapp className="inline-block size-5" /> Contact Me
              </a>
            </div>
        ...
        <div className="container">
          <div className="flex flex-wrap">
            <div className="mb-10 w-full px-4">
              <h1 className="mb-3 text-center text-lg font-bold uppercase text-primary">Skills</h1>
          ...
          <div className="flex flex-wrap">
            ...
            <div className="mb-2 w-full px-4">
              <div className="flex items-center">
                ...
                />
                <div className="flex flex-wrap">
                  <h2 className="w-full text-xl font-bold">PT Tabel Data Informatika</h2>
            ...
            <div className="w-full px-4">
              <p className="text-justify text-slate-700">
                As a Full Stack Developer, I was responsible for designing, developing, and
                maintaining both front-end and back-end components of web applications. My key
              ...
              <ul className="list-outside list-disc pl-4 pt-2">
                ...
                <li>
                  Building and consuming RESTful APIs to integrate various services and systems
                </li>
                <li>Implementing responsive web design</li>
                <li>Debugging and troubleshooting issues</li>
                <li>Code reviews to maintain high-quality standards and improve codebase</li>
                <li>Continuously learning and adopting new technologies and best practices</li>
              </ul>
              <p className="pt-2 text-justify text-slate-700">
                the web applications that have been worked on during my work, namely:
              </p>
              <ul className="list-outside list-disc pl-4 pt-2">
            ...
            <div className="group mb-12 rounded-lg p-4 hover:bg-white hover:opacity-90 md:w-1/2">
              <Link href="https://www.kacasooca.com/" target="_blank">
                ...
                <p className="text-base font-medium">
                  A catalog website for eyeglasses featuring frames and lenses originating from
