          ...
          <div className="flex flex-wrap">
            <div className="w-full self-center px-4 lg:w-1/2">
              <h1 className="text-base font-semibold text-primary md:text-xl">
                Hi, I am
                <span className="block font-bold text-4xl text-dark lg:text-5xl">
                  Aprian Firlanda Imani
                </span>
              </h1>
              <h2 className="font-medium text-secondary text-lg mb-5">Full Stack Web Developer</h2>
              <p className="font-medium text-secondary mb-10">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam deleniti, facere laudantium
                perspiciatis quia rerum!
              </p>
              <a href="#"
                 className="text-base font-semibold bg-primary py-3 px-8 text-white rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out">
                Contact Me
              </a>
            </div>
            <div className="w-full self-end px-4 lg:w-1/2">
              <div className="relative mt-10 lg:mt-9 lg:right-0">
                <Image width="499" height="499" src="/profile-pic.png" alt="Profile Picture"
          ...
          <div className="flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-1/2">
              ...
              <div className="flex items-center">
                <a href="https://github.com/aprianfirlanda" target="_blank"
                   className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-secondary hover:border-primary hover:bg-primary hover:text-white">
                ...
                <a href="https://www.linkedin.com/in/aprian-firlanda-imani-108852130/" target="_blank"
                   className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-secondary hover:border-primary hover:bg-primary hover:text-white">
                  <svg role="img" width="20" className="fill-current" viewBox="0 0 24 24"
                       xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://www.instagram.com/virlandd/" target="_blank"
                   className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-secondary hover:border-primary hover:bg-primary hover:text-white">
                  <svg role="img" width="20" className="fill-current" viewBox="0 0 24 24"
                       xmlns="http://www.w3.org/2000/svg">
